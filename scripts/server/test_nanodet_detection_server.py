...
# @File    : test_nanodet_detection_server.py
# @IDE: PyCharm
"""
Test NanoDet detection server
"""
import argparse
import os
...
def test_nanodet_detection_server_once():
    """
    ...
    url = 'http://localhost:8094/mortred_ai_server_v1/obj_detection/nanodet'
...
if __name__ == '__main__':
    ...
    if args.mode == 'single':
        for i in range(1000):
            test_nanodet_detection_server_once()
    elif args.mode == 'locust':
        command = 'locust -f ./server/test_nanodet_detection_server.py ' \
                  '--host=http://localhost:8094/mortred_ai_server_v1/obj_detection/nanodet --headless ' \
