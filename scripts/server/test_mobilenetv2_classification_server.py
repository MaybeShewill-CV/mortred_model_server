...
# @File    : test_mobilenetv2_classification_server.py
# @IDE: PyCharm
"""
Test mobilenetv2 classification server
"""
import argparse
import os
...
def test_mobilenetv2_classification_server_once():
    """
    ...
    url = 'http://localhost:8091/morted_ai_server_v1/classification/mobilenetv2'
...
class ClientBehavior(locust.TaskSet):
    ...
    @locust.task(1)
    def test_mobilenetv2_classification_server(self):
        """
...
if __name__ == '__main__':
    ...
    if args.mode == 'single':
        for i in range(1000):
            test_mobilenetv2_classification_server_once()
    elif args.mode == 'locust':
        command = 'locust -f ./server/test_mobilenetv2_classification_server.py ' \
                  '--host=http://localhost:8091/morted_ai_server_v1/classification/mobilenetv2 --headless ' \
