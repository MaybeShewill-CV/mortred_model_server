...
# @File    : test_resnet_classification_server.py
# @IDE: PyCharm
"""
...
def test_resnet_classification_server_once():
    """
...
if __name__ == '__main__':
    ...
    if args.mode == 'single':
        ...
        command = 'locust -f ./server/test_resnet_classification_server.py --headless ' \
