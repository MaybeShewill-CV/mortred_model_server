...
def test_yolov5_detection_server_once():
    ...
    # url = 'http://maybeshewill-cv.natapp1.cc/mortred_ai_server_v1/obj_detection/yolov5'
    url = 'http://localhost:8094/mortred_ai_server_v1/obj_detection/yolov5'
...
if __name__ == '__main__':
    ...
    if args.mode == 'single':
        ...
        command = 'locust -f ./server/test_yolov5_detection_server.py ' \
                  '--host=http://localhost:8094/mortred_ai_server_v1/obj_detection/yolov5 --headless ' \
