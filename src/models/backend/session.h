...
class InferenceSession {
  public:
     ...
     * copy with the concrete run-time shapes. Rank-4 tensors are NCHW when C
     * is dim1 ([N,C,H,W]) and NHWC when C is dim3 ([N,H,W,C]); rank-1/2 are
     * Linear. Rank-3 stays Unknown.
     *
