...
jinq::common::StatusCode DenseNet<INPUT, OUTPUT>::on_init(const toml::table& params) {
...
template<typename INPUT, typename OUTPUT>
std::vector<NamedTensor> DenseNet<INPUT, OUTPUT>::preprocess(const cv::Mat& input_image) {
...
template<typename INPUT, typename OUTPUT>
jinq::common::StatusCode DenseNet<INPUT, OUTPUT>::postprocess(
...
DenseNet<INPUT, OUTPUT>::DenseNet()
    : jinq::models::BackendCvModel<INPUT, OUTPUT>("DENSENET") {}
