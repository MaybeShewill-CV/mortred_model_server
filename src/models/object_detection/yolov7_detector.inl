...
StatusCode YoloV7Detector<INPUT, OUTPUT>::Impl::init(const toml::table& config) {
    ...
    auto init_status = _m_net.tomlt(cfg_content, {"images"}, {"output", "518", "532"});
    ...
    LOG(INFO) << "YoloV7 detection model initialization complete!!!";
...
yolov7_impl::internal_output YoloV7Detector<INPUT, OUTPUT>::Impl::decode_outputs() const {
    ...
    const MNN::Tensor* heads[3] = {_m_net.output("output"), _m_net.output("518"), _m_net.output("532")};
