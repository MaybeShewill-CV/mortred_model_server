...
int main(int argc, char** argv) {
    // batch mode (--batch N / --loops M) is provided generically by
    // run_benchmark: functional gate (every item OK) + batch/s + img/s
    ...
    spec.usage = "exe config_file_path [test_image_path] [--batch N] [--loops M]";
    spec.loops = 1000;
