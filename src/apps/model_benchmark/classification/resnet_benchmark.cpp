...
int main(int argc, char** argv) {
    ...
    spec.model_name = "resnet";
    spec.display_name = "resnet classifier";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::classification::create_resnet_classifier<mat_input, std_classification_output>(model_name);
    };
