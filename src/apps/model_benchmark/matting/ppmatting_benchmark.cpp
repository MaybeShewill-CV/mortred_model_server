...
int main(int argc, char** argv) {
    ...
    spec.display_name = "ppmatting segmentor";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::matting::create_ppmatting_segmentor<mat_input, std_matting_output>(model_name);
    };
