...
void save_enhanced(const mat_input&, const std_enhancement_output& out, const std::string& image_path) {
    ...
    std::string output_path = jinq::common::FilePathUtil::concat_path(
        "../demo_data/model_test_input/enhancement/derain", output_file_name);
...
int main(int argc, char** argv) {
    ...
    spec.model_name = "attentive_gan";
    spec.display_name = "attentivegan enhancementor";
    ...
    spec.make_input = [](int argc, char** argv, const toml::table&) {
        return jinq::apps::make_single_image_input(argc, argv, "../demo_data/model_test_input/enhancement/derain/test_1.png");
    };
    spec.image_path_of = [](int argc, char** argv) {
        return jinq::apps::standard_image_path(argc, argv, "../demo_data/model_test_input/enhancement/derain/test_1.png");
    };
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::enhancement::create_attentivegan_enhancementor<mat_input, std_enhancement_output>(model_name);
    };
