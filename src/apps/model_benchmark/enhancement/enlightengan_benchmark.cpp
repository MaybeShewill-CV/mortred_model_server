...
int main(int argc, char** argv) {
    ...
    spec.make_input = [](int argc, char** argv, const toml::table&) {
        return jinq::apps::make_single_image_input(argc, argv, "../demo_data/model_test_input/enhancement/low_light/lol_test_1.png");
    };
    spec.image_path_of = [](int argc, char** argv) {
        return jinq::apps::standard_image_path(argc, argv, "../demo_data/model_test_input/enhancement/low_light/lol_test_1.png");
    };
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::enhancement::create_enlightengan_enhancementor<mat_input, std_enhancement_output>(model_name);
    };
