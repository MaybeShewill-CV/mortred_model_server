...
* File: nanodet_benchmark.cpp
* Date: 2026-08-19
************************************************/

// nanodet benchmark tool
...
int main(int argc, char** argv) {
    ...
    spec.model_name = "nanodet";
    spec.display_name = "nanodet detector";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::object_detection::create_nanodet_detector<mat_input, std_object_detection_output>(model_name);
    };
