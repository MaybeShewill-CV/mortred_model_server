 ...
 * File: yolov6_benchmark.cpp
 * Date: 26-8-19
 ************************************************/

// yolov6 benchmark tool
...
void vis_and_save(const mat_input& in, const std_object_detection_output& out, const std::string& image_path) {
    ...
    output_file_name = output_file_name.substr(0, output_file_name.find_last_of('.')) + "_yolov6_result.png";
...
int main(int argc, char** argv) {
    ...
    spec.model_name = "yolov6";
    spec.display_name = "yolov6 detector";
    ...
    spec.make_input = [](int argc, char** argv, const toml::table&) {
        return jinq::apps::make_single_image_input(argc, argv, "../demo_data/model_test_input/object_detection/bus.jpg");
    };
    spec.image_path_of = [](int argc, char** argv) {
        return jinq::apps::standard_image_path(argc, argv, "../demo_data/model_test_input/object_detection/bus.jpg");
    };
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::object_detection::create_yolov6_detector<mat_input, std_object_detection_output>(model_name);
    };
