...
* File: yolov8_benchmark.cpp
* Date: 2026-08-19
************************************************/

// yolov8 benchmark tool
...
int main(int argc, char** argv) {
    ...
    spec.model_name = "yolov8";
    spec.display_name = "yolov8 detector";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::object_detection::create_yolov8_detector<mat_input, std_object_detection_output>(model_name);
    };
