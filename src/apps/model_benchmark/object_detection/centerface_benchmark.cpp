...
int main(int argc, char** argv) {
    ...
    spec.model_name = "center_face";
    spec.display_name = "centerface detector";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::object_detection::create_centerface_detector<mat_input, std_face_detection_output>(model_name);
    };
