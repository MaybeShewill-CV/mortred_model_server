...
int main(int argc, char** argv) {
    ...
    spec.model_name = "bisenetv2";
    spec.display_name = "bisenetv2 segmentor";
    ...
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::scene_segmentation::create_bisenetv2_segmentor<mat_input, std_scene_segmentation_output>(model_name);
    };
