 ...
 * Date: 23-11-17
 ************************************************/
// hrnet segmentation benchmark tool
...
int main(int argc, char** argv) {
    ...
    if (argc == 3) {
        ...
        input_image_path = "../demo_data/model_test_input/scene_segmentation/00000_266092.jpg";
    ...
    LOG(INFO) << "start hrnet benchmark at: " << Timestamp::now().to_format_str();
