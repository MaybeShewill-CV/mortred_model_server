...
void save_colorized(const mat_input&, const std_scene_segmentation_output& out, const std::string& image_path) {
    ...
    output_file_name = output_file_name.substr(0, output_file_name.find_last_of('.')) + "_hrnet_result.png";
...
int main(int argc, char** argv) {
    ...
    spec.model_name = "hrnet_segmentor";
    spec.display_name = "hrnet segmentor";
    ...
    spec.make_input = [](int argc, char** argv, const toml::table&) {
        return jinq::apps::make_single_image_input(argc, argv, "../demo_data/model_test_input/scene_segmentation/00000_266092.jpg");
    };
    spec.image_path_of = [](int argc, char** argv) {
        return jinq::apps::standard_image_path(argc, argv, "../demo_data/model_test_input/scene_segmentation/00000_266092.jpg");
    };
    spec.make_model = [](const std::string& model_name) {
        return jinq::factory::scene_segmentation::create_hrnet_segmentor<mat_input, std_scene_segmentation_output>(model_name);
    };
