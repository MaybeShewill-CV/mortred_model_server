...
using jinq::factory::scene_segmentation::create_ppmatting_segmentor;
...
int main(int argc, char** argv) {
    ...
    // construct detector
    auto segmentor = create_ppmatting_segmentor<mat_input, std_scene_segmentation_output>("pphuman");
