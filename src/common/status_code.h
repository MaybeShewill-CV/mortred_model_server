...
constexpr int to_underlying(StatusCode code) { return static_cast<int>(code); }
...
inline std::ostream &operator<<(std::ostream &os, StatusCode code) { return os << static_cast<int>(code); }
